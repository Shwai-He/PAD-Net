...
class DyMobileNetV2(TempModule):
    def __init__(self, conv_layer, num_classes=1000, width_multiplier=0.35, dropout=None):
        super(DyMobileNetV2, self).__init__(ConvLayer=conv_layer)
        ...
        self.classifier = Conv2d(output_channel, num_classes, kernel_size=1, stride=1)
        classifier = []
...
def Dymobilenetv2(**kwargs):
    """
    Constructs a MobileNet V2 model
    """
    conv_layer = dynamic_convolution_generator(nof_kernels=4)
    return DyMobileNetV2(conv_layer=conv_layer, **kwargs)
